                    ...
                    <div className="grid lg:grid-cols-12 grid-cols-1 items-center">
                        <div className="lg:col-span-6">
                            <div className="text-center lg:text-start mb-[50px] lg:mb-0">
                                <h6 className="text-black uppercase text-[14px] md:text-[16px] tracking-[2px] font-[600] mb-[20px] md:mb-[30px]">👋, My name is Apin</h6>
                                ...
                                <p className="text-[16px] md:text-[20px] mb-[8px] md:mb-[16px]">Based in Bandung, Indonesia.</p>
                                <div className="pt-[10px]">
                                    <Link className="px-btn px-btn-theme" to="contactus">Yuk Ah</Link>
                                </div>
                            </div>
                        </div>
                        <div className="lg:col-span-6">
